...
=======
En este Ejercicio se propone que realicen el dise√±o, sintentizaciÛn e implementaciÛn del Display de 7 sergmentos, el cual permita visualizar n√∫meros  en representaciÛn hexadecimal (0x0 a 0xF).  
