...
=======
En este Ejercicio se propone que realicen el diseÃ±o, sintentización e implementación del Display de 7 sergmentos, el cual permita visualizar nÃºmeros  en representación hexadecimal (0x0 a 0xF).  
...
* Selector de ínodo: Sincronizado con la frecuencia  que genera el divisor, cambia en cada instante de tiempo el  ánodo, se puede ver como un registro de desplazamiento del bit 0 `1110 1101 1011 0111`
...
#### En esta simulación se evidencia en la  primera Fila el número que se desea visualizar los Displays. En la segunda fila está el código binario para representar cáda dígito en los Displays 7Segmentos y en la tercera fila está implísito con un "0" cero el ánodo del display que estará activo en cada instante de tiempo a su respectivo orden establecido.
=======
